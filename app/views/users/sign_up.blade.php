   ...
   @include('flash::message')
    ...
    <div id="start" class="container">
        <div class="page-title">
             <h1 class="page_h1"> REGISTER </h1>
             <h2 class="page_h2" style="margin-top:0px">  CREATE A NEW ACCOUNT </h2>
        </div>
    </div>
    <br/>
    <div class="container">
          ...
          <div class="col-lg-6 col-md-6" style="padding-right:30px; width: 100%; margin: auto;">
             <div class="application_form">
               <h1 class="contact_info_title" style="padding-left:15px;"> PERSONAL INFORMATION </h1>
                 ...
                 {{ Form::open(['route' => 'confirm_sign_up_path', 'role' => 'form', 'id'=> 'signup_form']) }}
                
                    <table class="careers_table">
                      <tr>
                          <td> Username <span class="red_asterix">*</span>: </td>
                          <td> <input type="text" id="username" name="username" class="career_input" placeholder="Username" value="{{Input::old('username')}}"/> </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td> <input type="text" name="firstname" class="career_input" placeholder="First name" value="{{Input::old('firstname')}}"/> </td>
                      </tr>
                      <tr>
                        <td class="tooltip_td" colspan="2">
                      ...
                      <tr>
                        ...
                        <td> <input name="lastname" type="text" class="career_input" placeholder="Last name" value="{{Input::old('lastname')}}"/>  </td>
                      </tr>
                     <tr>
                        <td class="tooltip_td" colspan="2">
                      ...
                      <tr>
                        ...
                        <td> <input name="email" type="email" class="career_input" placeholder="Email" value="{{Input::old('email')}}"/>  </td>
                      </tr>
                      <tr>
                        <td class="tooltip_td" colspan="2">
                              @if ($errors->has('email'))
                      ...
                      <tr>
                        ...
                        <td> <input name="phone" type="text" class="career_input" placeholder="Phone" value="{{Input::old('phone')}}"/>  </td>
                      </tr>
                      <tr>
                        <td class="tooltip_td" colspan="2">
                              @if ($errors->has('phone'))
                      ...
                      <tr>
                        ...
                        <td>  <div id="max-year-birthday"></div> <span class="birth_val validation"> </span>
                            @if ($errors->has('birth_month'))
                              <span style="text-align:center;" class="validation">
                                    {{ $errors->get('birth_month')['0'] }} --  
                              </span>
                            @endif

                            @if ($errors->has('birth_day'))
                              <span style="text-align:center;" class="validation">
                                    {{ $errors->get('birth_day')['0'] }} --  
                              </span>
                            @endif

                            @if ($errors->has('birth_year'))
                              <span style="text-align:center;" class="validation">
                                    {{ $errors->get('birth_year')['0'] }}
                              </span>
                            @endif
                      ...
                      <tr>
                        ...
                        <td> <input id="password" name="password" type="password" class="career_input" placeholder="Password" value="{{Input::old('password')}}"/>  </td>
                      </tr>
                      <tr>
                        <td class="tooltip_td" colspan="2">
                      ...
                      <tr>
                        <td> Re-Password <span class="red_asterix">*</span>: </td>
                        <td> <input name="re-password" type="password" class="career_input" placeholder="Re-Password" value="{{Input::old('re-password')}}"/>  </td>
                      </tr>
                      <tr>
                        <td class="tooltip_td" colspan="2">
                              @if ($errors->has('re-password'))
                              <div class="validation">
                                    {{ $errors->get('re-password')['0'] }} 
                              </div>
                              @endif
                        </td> 
                      </tr>  
                      ...
                      <tr>
                        <td class="tooltip_td"> Newsletter <span class="red_asterix">*</span>: </td>
                        <td>
                          <input id="subscribe" type="radio" name="newsletters" value="1" checked/> <label for="subscribe"> Subscribe </label><br/>
                          <input id="unsubscribe" type="radio" name="newsletters" value="0"/> <label for="unsubscribe"> Unsubscribe </label>
                        </td>
                      </tr>
                 ...
                 <h1 class="contact_info_title" style="padding-left:15px;"> DELIVERY INFORMATION </h1>
                    ...
                    <table class="careers_table">
                        <tr>
                             ...
                             <td>  <select class="career_input" name="country" id="country"> 
                         ...
                         <tr>
                          ...
                          <tr>
                            <td> Address <span class="red_asterix">*</span>: </td>
                            <td> <input id="test" type="text" class="career_input" placeholder="Address" name="address" value="{{Input::old('address')}}"/>  </td>
                          </tr>
                           <td class="tooltip_td" colspan="2">
                          ...
                          <tr>
                            <td> Enter Image Text: <span class="red_asterix">*</span>: <br/><br/> </td>
                            <td> <input id="captcha" name="captcha" type="text" class="career_input" placeholder="Enter Image Text"/>  </td>
                          </tr>

                          <tr>
                            <td> </td>
                             <td id="imgparent">
                                <div id="imgdiv"><img id="img" src="php/captcha.php" /> </div><img id="reload" src="images/reload.png" />
                                <div class="captcha_val validation">  </div>
                            </td>
                          </tr>

                          <tr>
                              <td></td>
                              <td style="text-align:right;"> <input type="button" class="submit_sign_up" value="Register"/>  </td>
                            </tr>
