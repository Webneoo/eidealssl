                 ...
                 <tr>
                    ...
                    <td>
                        ...
                        <div style="text-align:center"> 
                            ...
                            <a onclick="return confirm('Are you sure you want to accept the order ID # {{ $t->order_id }} ?');" href="{{ route('paypal_validation_path', array($t->order_id, '8') ) }}" class="btn btn-success btn-xs"> Accept </a>
