   ...
   <div class="sidebar-nav navbar-collapse">
       <ul class="nav" id="side-menu">
           <li class="sidebar-search">
             ...
             <li> <a <?php if ($pagename == "cms-news-management") echo 'class="active"'; ?> href="{{ route('news_management_path') }}">  <i class="fa fa-newspaper-o fa-fw"></i> News</a></li>
             <li> <a <?php if ($pagename == "cms-video-management") echo 'class="active"'; ?> href="{{ route('video_management_path') }}">  <i class="fa fa-video-camera fa-fw"></i> Videos</a></li>
